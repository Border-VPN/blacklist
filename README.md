...
Добавлен workflow `.github/workflows/sync-blacklist.yml`, который выполняется по расписанию (каждые 24 часа) и автоматически синхронизирует чёрный список из двух источников:
...
1. Получает `blacklist.txt` из обоих репозиториев.
